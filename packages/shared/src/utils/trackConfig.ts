...
const trackConfig = {
  ...
  splines: [
    {
      name: "Intro",
      coverSrc: "pixel-Intro-GrandSoleil.png",
      pathGifSrc: "visualiser-Intro.gif",
      normals: [],
      points: [
        new Vector3(-0.20003719667266, 0, 0.09996282175996),
        new Vector3(-0.19999757376361, 0, -0.10000245682295),
        new Vector3(0.35000010623753, 0, -0.65000008775547),
        new Vector3(1.63442364309319e-7, 0, -1.00000014496029),
        new Vector3(-0.34999989376245, 0, -0.65000020216512),
        new Vector3(0.20000001634424, 0, -0.10000011227185),
        new Vector3(0.19999998365578, 0, 0.09999988772817),
        new Vector3(-0.35000010623751, 0, 0.64999979783486),
        new Vector3(-1.63442327894003e-7, 0, 0.99999985503966),
        new Vector3(0.34999989376249, 0, 0.64999991224451),
      ],
    },
    {
      name: "triangle",
      ...
      normals: [],
      points: [
        new Vector3(-0.43332918704287, 0, 0.95262410922704),
        new Vector3(0.43332954160325, 0, -0.54847177657652),
        new Vector3(6.51302689114175e-7, 0, -0.95262437215964),
        new Vector3(-0.43332873159658, 0, -0.54847203931733),
        new Vector3(0.43332908652284, 0, 0.95262437217911),
        new Vector3(0.999999999965, 0, 0.77942681089589),
        new Vector3(0.86665844493567, 0, 0.20207659630907),
        new Vector3(-0.86665809000944, 0, 0.20207573613021),
        new Vector3(-1.000000000035, 0, 0.77942605992268),
      ],
    },
    {
      name: "triangle 3D",
